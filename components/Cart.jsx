...
const Cart = () => {
  ...
  const { totalPrice, totalQuantities, cartItems, onClickCartIcon, toggleCartItemQuantity, onRemove } = useStateContext();
  ...
  return (
    <div className="cart-wrapper" ref={cartRef}>
      <div className="cart-container">
        <button type="button" className="cart-heading" onClick={onClickCartIcon}>
          <AiOutlineLeft/>
        ...
        <div className="empty-cart">
          ...
          <Link href="/">
            <button className="btn" type="button" onClick={onClickCartIcon}>
              Continue Shopping
            </button>
          </Link>
        </div>
